...
public class AdbShell extends Activity implements DeviceConnectionListener, OnKeyListener, OnEditorActionListener {
	...
	public void notifyConnectionEstablished(DeviceConnection devConn) {
		...
		stopApp("com.mediatek.wwtv.tvrecommendation");
		stopApp("com.cybercat.adbappcontrol.tv");
		stopApp("com.directv.dtvlatam");
		stopApp("com.airoha.ble.ota");
		stopApp("com.mediatek.wwtv.setupwizard");
		...
		stopApp("com.wbd.stream");
		stopApp("com.google.android.tvrecommendations");
		stopApp("com.google.android.leanbacklauncher.recommendations");
		stopApp("com.disney.starplus");
		stopApp("com.mediatek.tv.factory");
		stopApp("tv.twitch.android.app");
		stopApp("com.topjohnwu.magisk");
		stopApp("com.mstar.netflixobserver");
		stopApp("com.mediatek.wwtv.tvcenter");
